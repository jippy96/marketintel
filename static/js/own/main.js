$(document).ready(function () {
    ...
    function autocomplete(inp, arr) {
        ...
        inp.addEventListener("input", function (e) {
            ...
            // a partir de 5 caractères, je lance la requete
            if (val.length >= 5) {
                // execution de la requete ajax ici pour renvoyer les items
                $.ajax({
                    type: "GET",
                    url: "/search",
                    data: {
            ...
            for (i = 0; i < arr.length; i++) {
                ...
                if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                    ...
                    b.addEventListener("click", function (e) {
                        ...
                        closeAllLists();
                        var url = "recherche/?q=" + this.getElementsByTagName("input")[0].value;
                        location.assign(url);
                    });
                    a.appendChild(b);
                }
